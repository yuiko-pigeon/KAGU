<footer class="footer">
    <section class="footer__inner">
            ...
            <div class="footer__copyright-area">
                ...
                <img src="<?php echo get_theme_file_uri( 'picture/footer-sp.png' ); ?>" alt="木製の椅子の座面から脚が写っている写真" class="footer__image-sp">
            </div>
        <div class="footer__image">
            <img src="<?php echo get_theme_file_uri( 'picture/footer-pc.png' ); ?>" alt="木製の椅子の座面から脚が写っている写真" class="footer__image-pc">
        </div>
</footer>
    </div>
    <?php wp_footer(); ?>
